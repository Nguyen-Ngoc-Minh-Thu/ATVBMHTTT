...
<%@ page import="RSASigner.RSASigner" %>
            ...
            <form action="/Register" method="post" class="form-horizontal" name="form1" onsubmit="return validation()">
                <fieldset id="account">
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="publicKey" value="<%= session.getAttribute("publicKey") %>"
                                   placeholder="Public Key" id="input-publickey"
                                   class="form-control" required/>
                        </div>
                        <div class="col-sm-12 text-right">
                            <!-- Nút "Tạo Key" -->
                            <button type="button" onclick="generateKey()" class="btn btn-default custom-button">Tạo
                                Key
                            </button>
                        </div>
                    </div>
...
<script>
    ...
    function generateKey() {
        // Gửi yêu cầu AJAX đến servlet để tạo khóa
        $.ajax({
            url: 'GenerateKeyServlet',
            type: 'GET',
